...
Once the issue has been resolved, the user is sent an SMS as an acknowledegment. The application allows users to report complaints on the following subjects:
